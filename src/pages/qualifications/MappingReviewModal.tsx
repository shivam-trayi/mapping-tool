...
export const MappingReviewModal: React.FC<MappingReviewModalProps> = ({
  ...
  const handleSave = () => {
    ...
    // Simulate API call
    setTimeout(() => {
      alert(`Successfully inserted ${selectedData.length} mapping entries into the system`);
      // Reset selections
      setSelectedItems(new Set());
      setSelectAll(false);
    }, 500);
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-6xl max-h-[90vh] mx-4"
        >
          <div className={cn(
            ...
            <div className={cn(
              "flex justify-between items-center p-6 border-b transition-colors",

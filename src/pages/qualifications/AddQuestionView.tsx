...
const AddQuestionView: React.FC = () => {
  const [currentView, setCurrentView] = useState<ViewType>('addQuestion');
  ...
  const handleAddQuestion = () => {
    ...
    setTimeout(() => {
      ...
      setNewQuestion({ text: '', language: 'English-US', type: 'Radio', options: [], active: true });
      setIsSaving(false);
      setCurrentView('edit'); // simulate returning to edit view
    }, 1000);
  };

...
const QualificationsMappingViewMock: React.FC = () => {
  ...
  // Mock qualifications
  const qualifications: Qualification[] = Array.from({ length: 23 }, (_, i) => ({
    id: `q${i+1}`,
  ...
  const handleSaveForReview = () => {
    ...
    alert(`Saved ${selectedData.length} qualifications for review (mock)`);
  };
...
export default QualificationsMappingViewMock;

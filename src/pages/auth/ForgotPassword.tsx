...
import { ResetPasswordForm, FormErrors } from "@/types/authTypes";
import { useAuth } from "@/context/AuthContext";
import { validateForgotPasswordForm } from "@/validation/authValidation";
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            >
              ...
              <span>SurveyMappingTool</span>
            </Link>
          </div>

          <Card className="border text-card-foreground shadow-sm p-8 shadow-elevated border-border/20 bg-background/95 backdrop-blur-md rounded-2xl hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="space-y-4">
              <Button
                ...
                className="w-full gradient-primary text-white font-medium shadow-md hover:shadow-lg transition-transform hover:scale-[1.02] active:scale-95"
              >
                Back to Login
              </Button>
              <Button
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border text-card-foreground shadow-sm p-8 shadow-elevated border-border/20 bg-background/95 backdrop-blur-md rounded-2xl hover:shadow-2xl transition-shadow duration-300">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              className="w-full gradient-primary text-white font-medium h-11 shadow-md hover:shadow-lg transition-transform hover:scale-[1.02] active:scale-95"
              disabled={isLoading}
            >
